...
class SkillContractTests(unittest.TestCase):
    ...
    def test_fable_is_a_bundled_root_only_planner_or_advisor(self) -> None:
        ...
        self.assertIn("--advisor-fable-model", SKILL)
        self.assertIn("--planner-fable-model", SKILL)
        ...
        self.assertIn("never extracts a token from Claude login", SKILL)
        self.assertIn("--anthropic-base-url", SKILL)
        self.assertIn("--anthropic-auth-token", SKILL)
        self.assertIn("seat-pinned primary model", SKILL)
        ...
        self.assertIn("report the default product path as `Claude Fable 5`", SKILL)
        self.assertIn("seat-pinned primary defaults to `claude-fable-5`", SKILL)
